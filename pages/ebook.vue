      ...
      <nav class="flex justify-around gap-20 items-center fixed bg-white top-0 left-0 w-full h-16 z-40 md:hidden">
        ...
        <button class="group">
          ...
          <div class="absolute my-3 -right-full w-full h-auto bg-white opacity-0 border transform group-focus:right-0 group-focus:opacity-100 transition-all duration-300">
                        ...
                        >   
                            ...
                            >
                                <input
                                    ...
                                    name="text"
                                    placeholder="Search"
                                    class="bg-white h-10 md:px-5 md:pr-10 rounded-full text-sm focus:outline-none"
                                />
                            </div>
                            <div class="overflow-x-auto overflow-y-auto">
                                <table class="table-auto min-w-max max-h-96" has-table>
                                    <thead>
                                        <tr>
                                            <th
                                    ...
                                    <tbody>
                                     ...
                                     <tr class="overflow-y-auto" v-for="data in ebook" :key="data.id">
                                            <td
                                            data-label="judul buku 1 (RPL)"
            ...
            <section class="bg-gray-100 py-20 md:px-16 px-3">
                <h3 class="text-center font-semibold text-5xl text-blue-500 font-serif pb-10">E-Book Angkatan </h3>
                <!-- filter component -->
             
          <FormField label="Filter By Jurusan">
         
                <select name="" id="" class="w-1/5  bg-gray-200 border border-gray-400 mb-5 rouded-md py-2 px-3">

                    <option  v-for="data in jurusan " :key="data.id" :value="data.id">{{ data.nama }}</option>
                </select>
        ...
        <table>
            <thead>
                ...
                <tr class="bg-[#63B4FF]">
                    ...
                    <th class="px-6 py-3 text-left text-xs font-medium text-white uppercase tracking-wider">Desc</th>
                 </tr>
            </thead>
            <tbody >
                <tr v-if="!loading">
