...
const submit = async () => {
  ...
  const { data, error } = await supabase.from('ebook').insert({
    judul: title.value,
    desc: desc.value,
    foto: urlfile.value,
    ...
    <SectionMain>
      ...
      <CardBox>
        <form @submit.prevent="submit">
          ...
          <FormField label="Judul Dan Jurusan">
          ...
          <FormField label="Deskripsi" help="Your Desc ">
          <FormControl
          v-model="desc"
            type="textarea"
